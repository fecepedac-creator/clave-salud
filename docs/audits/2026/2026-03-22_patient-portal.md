# Auditoría automática — Portal paciente y booking público
...
Flujos públicos de reserva, anulación y formularios de paciente.

### Puntos de foco
- Validaciones de entrada en flujos públicos
- Riesgos de fuga de información por rutas
- Resiliencia de reserva y cancelación
- Comportamiento UX en errores y borde
...
- `App.tsx`
- `tests/admin/navigation-ux.spec.ts`
...
|---|---|---|---|
| ✅ PASS | `npm run build` | 2026-03-22T21:37:48.677Z | 2026-03-22T21:37:59.460Z |
| ❌ FAIL | `npx playwright test tests/demo/smoke.spec.ts --reporter=line` | 2026-03-22T21:37:59.460Z | 2026-03-22T21:37:59.460Z |
| ❌ FAIL | `npx playwright test tests/admin/navigation-ux.spec.ts --reporter=line` | 2026-03-22T21:37:59.460Z | 2026-03-22T21:37:59.460Z |
...
### ❌ npx playwright test tests/demo/smoke.spec.ts --reporter=line
...
### ❌ npx playwright test tests/admin/navigation-ux.spec.ts --reporter=line
...
- [ ] **H-001** (ALTA)
  - Comando: `npx playwright test tests/demo/smoke.spec.ts --reporter=line`
  - Motivo: Comando falló durante la auditoría.
  - Recomendación: Instalar navegadores y re-ejecutar E2E: `npx playwright install`.
- [ ] **H-002** (ALTA)
  - Comando: `npx playwright test tests/admin/navigation-ux.spec.ts --reporter=line`
  - Motivo: Comando falló durante la auditoría.
  - Recomendación: Instalar navegadores y re-ejecutar E2E: `npx playwright install`.
...
- **Ruta del reporte:** `docs/audits/2026/2026-03-22_patient-portal.md`
- **Timestamp generado:** `2026-03-22T21:37:59.461Z`
