              ...
              <>
                ...
                {selectedKineProgram && (
                  <SessionModal
                    ...
                    onSave={(s) =>
                      handleSaveKineSession(selectedPatient, selectedKineProgram.id, s)
                    }
                  />
                )}
              </>
                ...
                <div className="bg-slate-800 text-white px-8 py-5 flex justify-between items-center rounded-t-2xl">
                  <h3 className="font-bold text-xl flex items-center gap-2">
                    {newConsultation.consultationType === "pscv" ? (
                      <>
                        <Activity className="w-6 h-6 text-emerald-400" /> Control Cardiovascular
                        (PSCV)
                      </>
                    ) : (
                      <>
                  ...
                  {newConsultation.consultationType === "pscv" ? (
                    ...
                    <div className="p-8 md:p-10 space-y-10 border-b border-slate-100">
                      ...
                      <div className="border border-slate-200 rounded-2xl bg-white shadow-sm overflow-hidden animate-fadeIn">
                        ...
                        >
                          <h4 className="text-lg font-bold text-slate-800 flex items-center gap-2">
                            <Activity className="w-5 h-5 text-cyan-500" /> Evaluación Médica
                            (Exámenes y Signos Vitales)
                          </h4>
                          <ChevronDown
                      ...
                      <div className="border border-slate-200 rounded-2xl bg-white shadow-sm overflow-hidden animate-fadeIn">
                        ...
                        >
                          <h4 className="text-lg font-bold text-slate-800 flex items-center gap-2">
                            <Edit className="w-5 h-5 text-emerald-500" /> Diagnóstico, Recetas e
                            Indicaciones
                          </h4>
                          <ChevronDown
                                ...
                                <>
                                  ...
                                  {!canPrescribeDrugs && (
                                    <p className="text-xs text-slate-400 mt-2 italic">
                                      * Su perfil no permite emitir recetas de medicamentos, solo
                                      indicaciones y certificados.
                                    </p>
                                  )}
                                </>
