...
export const DoctorSettingsTab: React.FC<DoctorSettingsTabProps> = ({
  ...
  const handleDeleteProfile = (id: string) => {
    setModalConfig({
      ...
      warningText:
        "Esta acción eliminará la agrupación de exámenes. Sus exámenes individuales no se verán afectados.",
      onConfirm: () => {
  ...
  const handleResetProfiles = () => {
    setModalConfig({
      ...
      warningText:
        "Esta acción reemplazará todos sus perfiles actuales por la configuración inicial del sistema.",
      onConfirm: () => {
  ...
  const handleDeleteCustomExam = (examId: string) => {
    setModalConfig({
      ...
      warningText:
        "Este examen también será removido de cualquier perfil de exámenes que lo contenga actualmente.",
      onConfirm: () => {
  ...
  const handleDeleteTemplate = (id: string) => {
    setModalConfig({
      ...
      warningText:
        "Esta acción no se puede deshacer y la plantilla no volverá a estar disponible para su uso.",
      onConfirm: () => {
