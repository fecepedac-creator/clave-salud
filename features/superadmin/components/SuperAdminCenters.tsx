          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="space-y-4">
              ...
              <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100">
                ...
                <div className="text-sm text-slate-600">
                  Genera un enlace seguro (token) para que el administrador cree su contraseña. Se enviará un correo automático si el servicio está activo. Expira en 7 días.
                </div>
                ...
                <div className="mt-3 flex flex-col gap-2">
                  ...
                  >
                    {isInvitingAdmin ? "Generando..." : "Generar y enviar invitación"}
                  </button>
