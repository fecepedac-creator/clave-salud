...
describe("perfiles clÃ­nicos de seguimiento", () => {
  it("incluye el perfil lipÃ­dico completo", () => {
  ...
  it("describe y agrega el perfil diabÃ©tico completo", () => {
  ...
  it("incluye los componentes solicitados de perfiles hepÃ¡tico y hemograma", () => {
  ...
  it("todos los componentes de perfiles existen en el catÃ¡logo editable", () => {
