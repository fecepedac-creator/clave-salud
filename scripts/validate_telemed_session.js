    ...
    recommendations: missing.map((item) => {
      switch (item) {
        case "consentReceived":
          return "Capturar consentimiento informado electrónico.";
        case "identityVerified":
          return "Registrar confirmación de identidad (RUT/Foto).";
        case "privacyConfirmed":
          return "Confirmar entorno privado en la sesión.";
        case "remoteLabel":
          return "Etiquetar la consulta como actividad de telemedicina.";
        default:
          return "Actualizar registro normativo.";
      }
    }),
  };
}
