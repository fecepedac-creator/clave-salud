...
test.describe("Doctor: PSCV Flow Automation", () => {
    test("should create a patient and complete a full PSCV control", async ({ page }) => {
        ...
        // Anamnesis/Diagnosis
        await page.fill('[data-testid="pscv-plan"]', "Test automatizado con Playwright completo y exitoso.");
        ...
        await expect(page.locator('text=Control Cardiovascular').first()).toBeVisible({ timeout: 15000 });
