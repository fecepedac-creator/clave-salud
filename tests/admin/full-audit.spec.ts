...
test.describe("No Session Tests", () => {
    ...
    test("E2E-05: Ruta directa sin sesión", async ({ page }) => {
        ...
        await expect(page.locator('[data-testid="view-container-center-portal"]')).toBeVisible({ timeout: 15000 });
    });
});
...
test.describe("Agenda & Clinical Operations", () => {
    ...
    test("E2E-11: Reserva pública exitosa", async ({ page }) => {
        ...
        const hour = page.locator('button:has-text("09:00"), button:has-text("10:00"), button:has-text("11:00")').first();
