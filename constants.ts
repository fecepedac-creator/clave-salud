...
export const TRACKED_EXAMS_OPTIONS = [
  ...
  { id: "glicemia_ayunas", label: "Glicemia en Ayunas", unit: "mg/dL", category: "Metabólico" },
  { id: "bun", label: "BUN (Nitrógeno Ureico)", unit: "mg/dL", category: "Renal" },
  { id: "rac", label: "RAC (Albúmina/Creatinina)", unit: "mg/g", category: "Renal" },
  { id: "colesterol_total", label: "Colesterol Total", unit: "mg/dL", category: "Lipídico" },
  { id: "colesterol_hdl", label: "Colesterol HDL", unit: "mg/dL", category: "Lipídico" },
  { id: "colesterol_ldl", label: "Colesterol LDL", unit: "mg/dL", category: "Lipídico" },
  { id: "trigliceridos", label: "Triglicéridos", unit: "mg/dL", category: "Lipídico" },
  { id: "bilirrubina_total", label: "Bilirrubina Total", unit: "mg/dL", category: "Hepático" },
  { id: "bilirrubina_directa", label: "Bilirrubina Directa", unit: "mg/dL", category: "Hepático" },
  {
  ...
  { id: "got_ast", label: "GOT (AST)", unit: "U/L", category: "Hepático" },
  { id: "gpt_alt", label: "GPT (ALT)", unit: "U/L", category: "Hepático" },
  { id: "ggt", label: "GGT", unit: "U/L", category: "Hepático" },
  { id: "fosfatasa_alcalina", label: "Fosfatasa Alcalina", unit: "U/L", category: "Hepático" },
  { id: "hematocrito", label: "Hematocrito", unit: "%", category: "Hematológico" },
  { id: "hemoglobina", label: "Hemoglobina", unit: "g/dL", category: "Hematológico" },
  { id: "leucocitos", label: "Recuento de Leucocitos", unit: "10³/µL", category: "Hematológico" },
  { id: "plaquetas", label: "Recuento de Plaquetas", unit: "10³/µL", category: "Hematológico" },
  { id: "vhs", label: "VHS", unit: "mm/h", category: "Hematológico" },
];
...
export const EXAM_PROFILES = [
  ...
  },
  {
    ...
    summary: "Glic + P. lipídico + Crea + BUN + RAC + HbA1c",
  },
  {
    id: "p_tiroides",
  ...
  },
  {
    ...
    summary: "VEF-1 + DLCO + caminata",
  },
  {
    id: "p_lipidico",
    label: "Perfil Lipídico",
    exams: ["colesterol_total", "colesterol_hdl", "colesterol_ldl", "trigliceridos"],
    description: "Colesterol total, HDL, LDL y triglicéridos.",
    summary: "Col T + HDL + LDL + TG",
  },
  {
    id: "p_hepatico",
    ...
    description: "Bilirrubinas, transaminasas, GGT y fosfatasa alcalina.",
    summary: "Bil T/D/I + GOT + GPT + GGT + F.A.",
  },
  {
    id: "p_hemograma",
    label: "Hemograma",
    exams: ["hematocrito", "hemoglobina", "leucocitos", "plaquetas", "vhs"],
    description: "Hematocrito, hemoglobina, recuentos y VHS.",
    summary: "Hcto + Hb + R. leuc + R. plaq + VHS",
  },
];
...
export const INITIAL_CENTERS: MedicalCenter[] = [
  ...
  },
  {
    ...
    legalInfo: {
      rut: "77.777.777-7",
      representativeName: "Admin User",
      representativePhone: "+56900000000",
      email: "admin@clavesalud.com",
