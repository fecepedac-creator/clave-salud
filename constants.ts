...
export const EXAM_PROFILES = [
    { id: 'p_renal', label: 'Perfil Renal', exams: ['creatinina', 'microalb'], description: 'Monitoreo de función renal y daño glomerular.' },
    { id: 'p_metabolico', label: 'Perfil Diabético / Metabólico', exams: ['hba1c', 'creatinina'], description: 'Control glucémico y prevención de daño orgánico.' },
    { id: 'p_tiroides', label: 'Perfil Tiroideo', exams: ['tsh', 't4l'], description: 'Evaluación de función tiroidea.' },
    { id: 'p_resp', label: 'Perfil Respiratorio (EPOC)', exams: ['vef1', 'dlco', 'caminata'], description: 'Seguimiento de capacidad pulmonar funcional.' },
];
...
export const INITIAL_CENTERS: MedicalCenter[] = [
    {
        ...
        isPinned: true,
        maxUsers: 10,
        allowedRoles: ["MEDICO", "ENFERMERA", "KINESIOLOGO", "PSICOLOGO", "ODONTOLOGO", "MATRONA", "TERAPEUTA_OCUPACIONAL", "PODOLOGO", "NUTRICIONISTA", "FONOAUDIOLOGO"],
...
export const LIVING_WITH_OPTIONS = [
  "Solo/a", "Esposo/a o Pareja", "Hijos", "Padres", "Hermanos", "Nietos", "Abuelos", "Sobrinos", "Otro"
];

export const MAULE_COMMUNES = [
  "Talca", "Curicó", "Linares", "Cauquenes", "Constitución", "San Javier", "Molina", "Parral", 
  "Longaví", "Teno", "Villa Alegre", "Rauco", "Romeral", "Sagrada Familia", "Hualañé", "Licantén", 
  "Curepto", "Pencahue", "Pelarco", "Río Claro", "San Clemente", "San Rafael", "Chanco", "Pelluhue", 
  "Colbún", "Retiro", "Yerbas Buenas", "Empedrado", "Vichuquén"
].sort();

export const COMMON_MEDICATIONS = [
  "Paracetamol 500mg", "Ibuprofeno 400mg", "Losartán 50mg", "Metformina 850mg", 
  "Amoxicilina 500mg", "Clorfenamina 4mg", "Ketorolaco 10mg"
].sort();

export const COMMON_DIAGNOSES = [
  "Hipertensión arterial", "Diabetes mellitus 2", "Caries dentina", "Pulpitis reversible", 
  "Lumbago mecánico", "Trastorno adaptativo", "Gripe", "Faringitis aguda"
].sort();
...
export const MOCK_PATIENTS: Patient[] = [
  {
    ...
    medications: [
      { id: 'm1', name: 'Losartán', dose: '50mg', frequency: 'Cada 12 hrs' }
    ],
    allergies: [],
    consultations: [],
    attachments: [],
