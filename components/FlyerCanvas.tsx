      ...
      >
        ...
        >
          ...
          >
            ...
            <div
              style={{
                marginBottom: isStory ? "40px" : "50px",
                display: "flex",
                justifyContent: "center",
              }}
            >
            ...
            >
              <img
                ...
                alt="QR Code"
                style={{
                  width: isStory ? "180px" : "190px",
                  height: isStory ? "180px" : "190px",
                  display: "block",
                }}
              />
            </div>
      ...
      >
        <div
          ...
          style={{
            ...
            height: `${dims.height}px`,
            transform: `scale(${scale})`,
            background: backgroundGradient.includes("linear-gradient")
              ? backgroundGradient
              : `linear-gradient(135deg, ${colorMap[center?.primaryColor || "teal"] || "#14b8a6"}, #1e293b)`,
      ...
      >
        ...
        >
          ...
          <div style={{ flex: 1, display: "flex", flexDirection: "column" }}>
            {/* Profesional Info */}
            <div
              style={{ display: "flex", alignItems: "center", gap: "30px", marginBottom: "40px" }}
            >
              {doctor.photoUrl ? (
                <img
                  src={doctor.photoUrl}
            ...
            >
              ...
              {availableSlots && availableSlots.length > 0 ? (
                ...
                <div style={{ fontSize: "26px", opacity: 0.8 }}>
                  Consulta disponibilidad actualizada
                </div>
              )}
            </div>
