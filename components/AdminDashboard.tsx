...
const AdminDashboard: React.FC<AdminDashboardProps> = ({
  ...
  type AdminTab = "command_center" | "doctors" | "agenda" | "whatsapp" | "audit" | "preadmissions";
        ...
        <div className="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto">
          ...
          <div className="flex gap-2 w-full md:w-auto justify-center">
            <button
              ...
              className="flex-1 md:flex-none flex items-center justify-center gap-2 text-sm font-bold text-indigo-400 hover:text-indigo-300 transition-colors bg-slate-900 px-4 py-2 rounded-lg border border-slate-700"
            >
              <Share2 className="w-4 h-4" /> <span className="md:inline">App</span>
            </button>
          </div>
