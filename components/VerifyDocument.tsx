...
import { CheckCircle, XCircle, ShieldCheck, Printer, Building2, Calendar, FileText } from "lucide-react";
        ...
        <div className="min-h-screen bg-slate-50 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto">
                <div className="bg-white rounded-[2.5rem] shadow-2xl border border-slate-100 overflow-hidden transform transition-all duration-500 hover:shadow-indigo-100">
                    ...
                    <div className="bg-indigo-600 p-8 text-white relative">
                        ...
                        <div className="flex items-center gap-4 mb-4">
                            ...
                            <h1 className="text-xl font-black uppercase tracking-widest">Verificación de Documento</h1>
                        </div>
                        <p className="text-indigo-100 font-medium opacity-80">Portal de Validez Clínica Interoperable</p>
                    </div>
                    ...
                    <div className="p-8 sm:p-12">
                        {error ? (
                            <div className="text-center animate-fadeIn">
                                ...
                                <h2 className="text-2xl font-black text-slate-800 mb-2">Documento no verificable</h2>
                            ...
                            <div className="animate-fadeIn">
                                ...
                                <div className="flex items-center justify-center gap-3 bg-emerald-50 border border-emerald-100 text-emerald-700 py-6 rounded-3xl mb-10 shadow-inner">
                                    ...
                                    <div className="text-left">
                                        <p className="text-xs font-black uppercase tracking-tighter opacity-70">Estado del Documento</p>
                                ...
                                <div className="space-y-8">
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                                        <div>
                                            <p className="text-[10px] font-black text-slate-400 uppercase mb-2 tracking-widest">Paciente</p>
                                        ...
                                        <div>
                                            <p className="text-[10px] font-black text-slate-400 uppercase mb-2 tracking-widest">Identificador Documento</p>
                                            <p className="text-sm font-mono font-bold text-indigo-600 break-all">{docData.docId}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-8">
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                <p className="text-[10px] font-black text-slate-400 uppercase mb-1">Emitido por</p>
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                <p className="text-[10px] font-black text-slate-400 uppercase mb-1">Institución</p>
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                <p className="text-[10px] font-black text-slate-400 uppercase mb-1">Fecha de Emisión</p>
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                <p className="text-[10px] font-black text-slate-400 uppercase mb-1">Última Verificación</p>
                                                <p className="text-sm font-bold text-slate-700">{new Date(docData.verifiedAt).toLocaleString('es-CL')}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="mt-12 p-6 bg-slate-50 rounded-2xl border border-dotted border-slate-300">
                                    <p className="text-[11px] text-slate-500 leading-relaxed text-center">
                                        Este documento ha sido generado electrónicamente a través de la plataforma <strong>ClaveSalud</strong> y cuenta con firma digital válida según los estándares de interoperabilidad de salud de Chile.
                                        La integridad del contenido puede ser verificada contrastando este portal con el documento impreso.
                                    </p>
                                </div>
                ...
                <div className="mt-8 text-center">
                    <p className="text-slate-400 text-xs font-medium">ClaveSalud © 2026 • Liderando la Interoperabilidad Clínica</p>
                </div>
            </div>
        </div>
    );
