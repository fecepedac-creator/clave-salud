...
const MarketingFlyerModal: React.FC<MarketingFlyerModalProps> = ({
  ...
  const gradientOptions = [
    {
      id: "gradient1",
      name: "Infinity Blue",
      value: "linear-gradient(135deg, #0ea5e9 0%, #0f766e 100%)",
    },
    {
      id: "gradient2",
      name: "Royal Velvet",
    ...
    },
    {
      id: "gradient3",
      name: "Sunrise Gold",
      value: "linear-gradient(135deg, #f59e0b 0%, #dc2626 100%)",
    },
    {
      id: "gradient4",
      name: "Modern Dark",
    ...
    },
    {
      id: "gradient7",
      name: "Rose Gold",
      value: "linear-gradient(135deg, #fb7185 0%, #be123c 100%)",
    },
    {
      id: "gradient8",
      name: "Slate Gray",
    ...
    },
    {
      id: "custom",
      name: "Personalizado",
      value: center?.branding?.colors?.primary
        ? `linear-gradient(135deg, ${center.branding.colors.primary} 0%, #1e293b 100%)`
        : "",
    },
  ];

  const selectedGradient =
    gradientOptions.find((g) => g.id === backgroundGradient)?.value || gradientOptions[0].value;
  ...
  const availableSlots = useMemo(
    () => (selectedDoctor ? getAvailableSlots(appointments, selectedDoctorId) : []),
        ...
        <div className="flex-1 overflow-auto p-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-1 space-y-4">
              ...
              {/* Selector de Fondo */}
              <div>
                <label className="block text-sm font-semibold text-slate-700 mb-2">Fondo</label>
                <div className="grid grid-cols-3 gap-2">
                  ...
                  <button
                    ...
                    onClick={() =>
                      showToast("Funcionalidad de subida de archivos en desarrollo...", "info")
                    }
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2">
                        <div
                          ...
                          style={{ background: center?.primaryColor || "#14b8a6" }}
                        ></div>
              ...
              <div className="bg-blue-50/50 p-4 rounded-xl border border-blue-100 mt-4 space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-blue-700 leading-tight">
                    Escribe la idea principal que deseas comunicar y dejaremos que la Inteligencia
                    Artificial de ClaveSalud redacte el mensaje perfecto.
                  </p>
                ...
                <div ref={resultRef} className="pt-2 border-t border-blue-200">
                  <div className="flex items-center justify-between mb-2">
                    <label
                      className={`block text-sm font-semibold transition-colors duration-500 ${highlightResult ? "text-green-600" : "text-slate-700"}`}
                    >
