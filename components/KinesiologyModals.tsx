...
export const SessionModal: React.FC<SessionModalProps> = ({
  ...
  const currentTechniques =
    program.type === "Kinesioterapia motora" ? TECHNIQUES_MOTORA : TECHNIQUES_RESPIRATORIA;
        ...
        <div className="p-5 border-b border-slate-100 flex justify-between items-center bg-slate-50">
          <div>
            <h3 className="font-bold text-lg text-slate-800 flex items-center gap-2">
              <ClipboardList className="w-5 h-5 text-emerald-600" /> Sesión {sessionNumber} de{" "}
            ...
            <div className="grid grid-cols-2 gap-2">
              {currentTechniques.map((t) => (
                <button
                  ...
                  className={`text-left px-3 py-2 rounded-lg text-xs font-bold transition-colors flex items-center gap-2 ${
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="space-y-1">
                      <input
                        ...
                        value={vitals.pre.pa}
                        onChange={(e) =>
                          setVitals({ ...vitals, pre: { ...vitals.pre, pa: e.target.value } })
                        }
                      />
                      <input
                        placeholder="FC (lpm)"
                        ...
                        value={vitals.pre.fc}
                        onChange={(e) =>
                          setVitals({ ...vitals, pre: { ...vitals.pre, fc: e.target.value } })
                        }
                      />
                    </div>
                  </div>
                  <div className="space-y-2">
                    ...
                    <div className="space-y-1">
                      <input
                        ...
                        onChange={(e) =>
                          setVitals({ ...vitals, post: { ...vitals.post, pa: e.target.value } })
                        }
                      />
                      <input
                        placeholder="FC"
                        ...
                        onChange={(e) =>
                          setVitals({ ...vitals, post: { ...vitals.post, fc: e.target.value } })
                        }
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="space-y-1">
                      <input
                        ...
                        value={oxy.pre.sat}
                        onChange={(e) =>
                          setOxy({ ...oxy, pre: { ...oxy.pre, sat: e.target.value } })
                        }
                      />
                      <input
                        placeholder="FC"
                        ...
                        value={oxy.pre.fc}
                        onChange={(e) =>
                          setOxy({ ...oxy, pre: { ...oxy.pre, fc: e.target.value } })
                        }
                      />
                    </div>
                  </div>
                  <div className="space-y-2">
                    ...
                    <div className="space-y-1">
                      <input
                        ...
                        value={oxy.post.sat}
                        onChange={(e) =>
                          setOxy({ ...oxy, post: { ...oxy.post, sat: e.target.value } })
                        }
                      />
                      <input
                        placeholder="FC"
                        ...
                        value={oxy.post.fc}
                        onChange={(e) =>
                          setOxy({ ...oxy, post: { ...oxy.post, fc: e.target.value } })
                        }
                      />
                    </div>
                  </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-col gap-1">
                {["Buena", "Regular", "Mala"].map((opt) => (
                  ...
                  >
                    {opt === "Buena" && "🙂"} {opt === "Regular" && "😐"} {opt === "Mala" && "😖"}{" "}
                    {opt}
                  </button>
                ))}
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-col gap-1">
                {["Mejoría", "Igual", "Empeora"].map((opt) => (
                  ...
                  >
                    {opt === "Mejoría" && "⬆"} {opt === "Igual" && "➡"} {opt === "Empeora" && "⬇"}{" "}
                    {opt}
                  </button>
                ))}
              </div>
