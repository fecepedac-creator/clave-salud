        ...
        for (const item of data) {
          ...
          for (const c of cDataList) {
            ...
            const consult: Consultation = {
              id: consultId,
              date:
                c.date === "Unknown" ? new Date().toISOString() : new Date(c.date).toISOString(),
          ...
          const patient: Patient = {
            ...
            medications:
              pData.medications?.map((m: any) => ({
                id: generateId(),
                name: m.name,
                dose: m.dose || "",
                frequency: m.frequency || "",
              })) || [],
            allergies: pData.background?.allergies
              ? [
                  {
                    id: generateId(),
                    type: "Otro",
                    substance: pData.background.allergies,
                    reaction: "",
                  },
                ]
              : [],
            ...
            <div className="space-y-4">
              <div className="bg-blue-50 p-4 rounded-lg flex items-start gap-3">
                ...
                <div className="text-sm text-blue-800">
                  ...
                  <p>
                    Sube el archivo <code>extracted_data.json</code> generado por el piloto.
                  </p>
                </div>
              </div>
