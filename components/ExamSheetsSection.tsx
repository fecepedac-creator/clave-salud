...
export const ExamSheetsSection: React.FC<ExamSheetsSectionProps> = ({
  ...
  const handleExamValueChange = (sheetId: string, examId: string, value: string) => {
    const sheet = examSheets.find((s) => s.id === sheetId);
    if (!sheet) return;
    handleUpdateSheet(sheetId, {
                      ...
                      return (
                        <div key={examId} className="relative group/input">
                          <div className="flex justify-between items-center mb-1">
                            ...
                            <button
                              onClick={() => handleRemoveExamFromSheet(sheet.id, examId)}
                          ...
                          <div className="relative">
                            <input
                              ...
                              onChange={(e) =>
                                handleExamValueChange(sheet.id, examId, e.target.value)
                              }
                              placeholder="0.0"
                            ...
                            />
                            <span className="absolute right-3 top-3 text-xs text-slate-400 pointer-events-none font-bold">
                              {unit}
                            </span>
                          </div>
                        </div>
